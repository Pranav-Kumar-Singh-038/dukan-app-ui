    ...
    return (
        <div>
            ...
            <div className="flex m-4 text-xs ">
                <div className="flex  m-2 rounded-xl p-1 w-20 justify-center bg-myLightgrey-500 text-Mygrey-500">
                    <div className="mr-1">Payouts</div>
                    <div>({payouts})</div>
                </div>

                <div className="flex  m-2 rounded-xl p-1 w-20 justify-center bg-myBlue-500 text-white">
